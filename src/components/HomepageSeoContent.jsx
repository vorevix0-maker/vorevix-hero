...
const services = [
  ["Web Development", "/services/web-development-services", "We build reliable, responsive and scalable websites that support real business requirements. Our development approach considers performance, search visibility, accessibility, maintainability, security and future growth from the beginning.", "Whether you need a business website, an eCommerce platform, a content-managed website or a custom digital solution, we focus on creating a dependable technical foundation."],
  ...
  ["UI/UX Design", "/services/ui-ux-design-services", "We design digital experiences that are clear, intuitive and aligned with how people use websites and digital products.", "Our UI/UX process helps improve navigation, reduce friction and create more consistent interactions across screens and devices."],
