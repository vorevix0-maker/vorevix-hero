...
export default function WebDesignAustraliaPage(){
  return <main className="web-development-page wda-page">
    ...
    <Section title="How Web Design Australia Connects to Your Wider Digital Strategy" tinted><p>A website becomes more valuable when related services work together. Branding improves consistency, UI/UX strengthens journeys, development turns designs into a working experience and SEO supports discoverability.</p><p>Depending on your project, explore our <a href="/services/web-design">global web design services</a>, <a href="/services/web-development-services">web development services</a>, <a href="/services/ui-ux-design-services">UI/UX design services</a>, <a href="/services/seo-services">SEO services</a> and <a href="/services/branding">branding services</a>. You can also review <a href="/portfolio">our portfolio</a> or <a href="/contact">contact Vorevix</a>.</p></Section>
