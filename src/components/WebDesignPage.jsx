...
export default function WebDesignPage() {
  return <main className="web-development-page web-design-page">
    ...
    <section className="wd-section web-design-faq"><div className="wd-section-heading"><h2>Frequently Asked Questions</h2></div><div className="web-design-faq-grid">{webDesignFaqs.map(([question,answer])=><article key={question}><h3>{question}</h3><p>{answer}</p></article>)}</div><p className="web-design-regional-note">Vorevix works with businesses worldwide and also provides <a href="/australia/web-design">web design services to organisations across Australia</a>, New Zealand and the United Arab Emirates.</p></section>
