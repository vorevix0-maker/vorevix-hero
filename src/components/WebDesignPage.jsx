...
export default function WebDesignPage() {
  return <main className="web-development-page web-design-page">
    ...
    <Section title="Web Design That Supports Search Visibility"><p>Web design and SEO are separate disciplines, but design decisions can support or obstruct search performance.</p><p>Our SEO-aware approach considers:</p><List items={["Logical page and heading structures","Clear areas for useful content","Internal linking opportunities","Mobile usability","Performance-conscious layouts","Crawl-friendly navigation concepts","Reusable templates for future pages"]}/><p>Technical SEO, structured data and performance implementation must be handled during development. Where required, we can connect the project with our <a href="/services/seo-services">SEO</a> and <a href="/services/web-development">web development services</a>.</p></Section>
    ...
    <Section title="From Design Strategy to Development-Ready Execution"><p>Web design defines how the website should communicate, look and behave. Web development turns that approved design into a functioning website.</p><p>You can use Vorevix for design only, or connect the project directly with our <a href="/services/web-development">web development service</a>. In either case, the handoff is planned to reduce ambiguity and preserve the design intent.</p></Section>
    ...
    <section className="wd-section web-design-faq"><div className="wd-section-heading"><h2>Frequently Asked Questions</h2></div><div className="web-design-faq-grid">{webDesignFaqs.map(([question,answer])=><article key={question}><h3>{question}</h3><p>{answer}</p></article>)}</div></section>
